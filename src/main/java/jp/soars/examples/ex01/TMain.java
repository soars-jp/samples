...
public class TMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        spotManager.createSpot(TSpotTypes.COMPANY, 10);
        //エージェントの初期化
        ...
        for (int i = 0; i < fathers.size(); ++i) {
            ...
            if (i == 1) { //1番目のエージェントだけ，4時間後に帰宅となるように，RULE_GO_TO_COMPANYを上書きする．
                TRuleOfLeavingHome ruleOfGoingToCompany = new TRuleOfLeavingHome(TFatherRole.RULE_GO_TO_COMPANY, fatherRole, home, TSpotTypes.COMPANY, 4);
